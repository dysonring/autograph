...
export function * contractCreate ({payload, metadata}) {
  try {
    ...
    const {ethereumSmartContractAddress, ethereumPrivateKey, ethereumSmartContractAbi } = payload
    ...
    if(ethereumPrivateKey) {
      ...
      contract = new ethers.Contract(ethereumSmartContractAddress, ethereumSmartContractAbi, wallet);
    } else {
      contract = new ethers.Contract(ethereumSmartContractAddress, ethereumSmartContractAbi, provider);
    }
